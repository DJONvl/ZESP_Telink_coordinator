...
{
    /* Headless gateway: the host drives everything over ZBHCI, and the
     * UART shares PB2/PB3 with the EVK buttons — scanning keys here would
     * mistake UART traffic for button presses (permit-join / toggles). */
    (void)0;
#if 0
